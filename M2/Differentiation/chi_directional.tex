...
\begin{document}
    ...
    \begin{definition}[全導數]
        設$f:\mathbb{R}^m\to\mathbb{R}^n$，而$(x_1,x_2,\dots,x_m)\overset{f}{\mapsto}(y_1,y_2,\dots,y_n)$。則$f$的全導數為$$\derivative{f}{x}:=(\derivative{y_1}{x},\derivative{y_2}{x},\dots,\derivative{y_n}{x})$$
    \end{definition}
