...
\begin{document}
    Let $\triangle ABC$ be an arbitrary valid triangle such that $AB,BC,CA$ satisfies the triangle inequality. Define $D$, $E$ and $F$ to be the midpoint of $BC$, $AC$, and $AB$ respectively.
\end{document}