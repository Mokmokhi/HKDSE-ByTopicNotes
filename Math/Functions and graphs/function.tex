...
\begin{document}
    ...
    \begin{example}
        Suppose a triangle $\triangle ABC$ with $AB=3, AC=5, \angle B = 60^\circ$. Then it is not hard to see \begin{align*}
            ...
            \sin{\angle C}&=\frac{3}{5\sin{60^\circ}}\\
            &=\frac{2\sqrt{3}}{5}\\
            \sin{\angle A}&=\sin{\angle B}\cos{\angle C}+\sin{\angle C}\cos{\angle B}\\
            &=\frac{\sqrt{3}}{2}\cdot \frac{\sqrt{13}}{5}+\frac{2\sqrt{3}}{5}\cdot \frac{1}{2}\\
            &=\frac{\sqrt{39}+2\sqrt{3}}{10}\\
            BC&=\frac{10\sqrt{3}}{3}\cdot\frac{\sqrt{39}+2\sqrt{3}}{10}\\
            &=2+\sqrt{13}
        \end{align*}
    \end{example}
    ...
    \begin{proof}
        Since we have done the proofs in sine and cosine law, we could directly apply them to any case.
    \end{proof}
