...
\begin{document}
    ...
    \begin{corollary}[Multinomial theorem]
        Let $x_1,x_2,\dots,x_k\in\mathbb{R}$ and $n\in\mathbb{N}$. Then \[(x_1+x_2+\cdots+x_k)^n=\sum_{r_1+r_2+\cdots+r_k=n}C_{r_1}^n C_{r_2}^{n-r_1}\cdots C_{r_{k-1}}^{n-r_1-r_2-\cdots-r_{k-2}} x_1^{r_1}x_2^{r_2}\cdots x_k^{r_k} \] where $C_r^n$ is defined by combination discussed in the section of counting functions.
    \end{corollary}
