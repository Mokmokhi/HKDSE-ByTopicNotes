...
\begin{document}
    ...
    In order to compute formula from all perspective, we now look at a well-known formula for computing area of an aritrary triangle using side length only. This is the Heron's formula.
