...
\begin{document}
    ...
    The equation derived in this part helps the intropduction to next session.

    \subsubsection*{The quadratic formula}

    The quadratic formula $$x=\frac{-b\pm\sqrt{b^2-4ac}}{2a}$$ is used to solve the quadratic equation directly when the equation has solution.
