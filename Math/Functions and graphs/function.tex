...
\begin{document}
    ...
    The above conclusions can be by graphical observation, or if we take from advantage of gepmetric interpretation, we can perform the following deduction:\begin{enumerate}
