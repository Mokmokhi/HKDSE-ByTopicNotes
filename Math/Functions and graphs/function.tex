...
\begin{document}
    ...
    \begin{theorem}
        There is no division in complex number, but a generalized inverse of complex numbers can be written \[z^{-1}=\frac{1}{|z|^2}(z^*)\]
    \end{theorem}

    \begin{example}[Complex roots with complex coefficients]
        Let $c(x):=(1+2i)z^2+(7-i)z+(2+3i)$, then \[z=\frac{-(7-i)\pm\sqrt{(7-i)^2-4(1+2i)(2+3i)}}{2(1+2i)}=\frac{-7+i\pm\sqrt{64-42i}}{2(1+2i)}=\]
    \end{example}
