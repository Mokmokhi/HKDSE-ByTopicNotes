...
\begin{document}
    ...
    Historically, the sine function is defined for the relation between the opposite sides of a given acute angle in a triangle and the hypotenuse of the triangle.
